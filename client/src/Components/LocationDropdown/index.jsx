    ...
    return(
        ...
        <Button className="locationDrop" onClick={() => setisOpenModal(true)}>
            <div className="info d-flex flex-column">
                ...
                <span className="name">{context.selectedCountry!=="" ? context.selectedCountry.length>10 ? context.selectedCountry?.substr(0,11)+'...' : context.selectedCountry: 'Select Location'}</span>
            </div>
